...
export function serializeProduct(doc: UnknownRecord): Product {
  return {
    ...
    name: doc.name as Product["name"],
    tagline: doc.tagline as Product["tagline"],
    ...
    features: (doc.features as Product["features"]) ?? { en: [], ro: [] },
...
export function serializeTestimonial(doc: UnknownRecord): Testimonial {
  return {
    ...
    quote: doc.quote as Testimonial["quote"],
